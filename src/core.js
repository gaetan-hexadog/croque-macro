...
function buildAssistantPrompt({
  ...
  if (!dining && !fridgeOnly && have.length) L.push(mode === "meal"
    ? "Si des aliments de mon frigo/placard collent bien à la demande, sers-t'en et signale-le (« tu as déjà X ») — mais reste LIBRE d'inventer avec des ingrédients standard : le frigo est un bonus, pas une obligation."
