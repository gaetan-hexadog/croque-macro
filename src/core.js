...
const MEALS = [
  ...
  { id: "bv1", name: "Clear Vegan Bulk + eau", slots: ["pdj", "dej", "snack"], kcal: 67, p: 15, c: 2, f: 1, tags: ["rapide", "transportable", "sans-oeuf", "bulk"], desc: "Clear Vegan Bulk (20 g, protéine de pois) à l'eau. Ultra léger : 67 kcal pour 15 g. Texture jus, pas crémeuse." },
  ...
  { id: "egg3", name: "Œufs brouillés (2 œufs)", slots: ["pdj", "dej", "diner"], kcal: 200, p: 13, c: 2, f: 15, tags: ["rapide", "basique"], desc: "Deux œufs brouillés, un peu de matière grasse." },
...
const MEAL_IDEAS = [
  // Petit-déj
  { id: "idea-oats", cat: "pdj", name: "Overnight oats protéiné", kcal: 390, p: 35, desc: "Se prépare la veille, se mange (ou se boit) en voiture.", ingredients: ["40 g de flocons d'avoine", "250 ml de lait d'amande", "1 dose de Vegan Protein", "une poignée de fruits rouges", "1 c. à café de graines de chia"], steps: ["La veille, mélange flocons + lait + protéine + chia dans un bocal.", "Laisse une nuit au frigo.", "Le matin, ajoute les fruits."] },
  { id: "idea-pancakes", cat: "pdj", name: "Pancakes protéinés", kcal: 400, p: 35, desc: "Sans huile, à la poêle antiadhésive.", ingredients: ["40 g de flocons mixés", "2 œufs", "1 banane écrasée", "1/2 dose de Vegan Protein", "cannelle"], steps: ["Mixe le tout en pâte.", "Cuis en petits pancakes, poêle antiadhésive sans huile.", "Garnis de fruits ou d'un filet de sirop léger."] },
  { id: "idea-tofuscramble", cat: "pdj", name: "Tofu brouillé express", kcal: 290, p: 22, desc: "L'alternative aux œufs, goût brouillé.", ingredients: ["150 g de tofu ferme", "curcuma, paprika, sel kala namak (goût œuf)", "1 tranche de pain complet"], steps: ["Écrase le tofu à la fourchette.", "Poêle antiadhésive + épices, 5 min.", "Sers avec le pain."] },
  { id: "idea-skyrmuesli", cat: "pdj", name: "Skyr soja & muesli", kcal: 320, p: 20, desc: "Rapide. Choisis un skyr SOJA (plus protéiné que l'amande) et un muesli sans sucre ajouté.", ingredients: ["150 g de skyr/yaourt soja protéiné", "40 g de muesli sans sucre ajouté", "fruits frais"], steps: ["Mélange skyr + muesli.", "Ajoute les fruits."] },
  // Déjeuner
  { id: "idea-buddha", cat: "dej", name: "Buddha bowl tofu", kcal: 470, p: 32, desc: "Protéiné, frais, sec en gras.", ingredients: ["150 g de tofu fumé ou teriyaki", "80 g de quinoa (cru) cuit", "80 g d'edamame", "crudités (carotte, chou, concombre)", "sauce soja + citron + gingembre"], steps: ["Cuis le quinoa.", "Poêle le tofu.", "Assemble avec edamame et crudités, nappe de sauce."] },
  { id: "idea-omelette", cat: "dej", name: "Omelette garnie", kcal: 400, p: 24, desc: "Rapide et rassasiant.", ingredients: ["3 œufs", "champignons + épinards", "1 tranche de pain complet"], steps: ["Fais revenir champignons et épinards.", "Verse les œufs battus, cuis l'omelette.", "Sers avec le pain."] },
  { id: "idea-steak", cat: "dej", name: "Steak végétal & légumes rôtis", kcal: 450, p: 30, desc: "Avec HappyVore ou Garden Gourmet.", ingredients: ["1 steak végétal", "grosse portion de légumes rôtis", "100 g de patate douce ou lentilles"], steps: ["Rôtis les légumes au four.", "Poêle le steak.", "Assemble."] },
  { id: "idea-wrap", cat: "dej", name: "Wrap protéiné", kcal: 400, p: 22, desc: "À emporter, se mange à une main.", ingredients: ["1 tortilla complète", "jambon La Vie ou tofu", "crudités", "1 c. à soupe de houmous"], steps: ["Tartine le houmous.", "Garnis de protéine + crudités.", "Roule serré."] },
  { id: "idea-medbowl", cat: "dej", name: "Bowl méditerranéen", kcal: 470, p: 26, desc: "Pois chiches + œuf, frais et complet.", ingredients: ["150 g de pois chiches", "1 œuf dur", "concombre + tomate", "60 g de boulgour (cru) cuit", "citron, herbes"], steps: ["Cuis le boulgour.", "Assemble pois chiches, œuf, légumes.", "Assaisonne citron + herbes."] },
  // Dîner
  { id: "idea-curry", cat: "diner", name: "Curry de pois chiches express", kcal: 520, p: 22, desc: "Réconfortant, prêt en 15 min.", ingredients: ["150 g de pois chiches", "150 ml de lait de coco allégé", "épinards", "tomate concassée + pâte de curry", "100 g de riz basmati (cru) cuit"], steps: ["Fais mijoter tomate + curry + coco.", "Ajoute pois chiches et épinards, 10 min.", "Sers sur le riz."] },
  { id: "idea-wok", cat: "diner", name: "Poêlée tofu-légumes & soba", kcal: 480, p: 28, desc: "Façon wok, vite fait.", ingredients: ["150 g de tofu teriyaki", "wok de légumes (poivron, brocoli, pousses)", "80 g de nouilles soba (crues) cuites", "sauce soja"], steps: ["Cuis les soba.", "Saute tofu + légumes au wok.", "Mélange, nappe de sauce."] },
  { id: "idea-galette", cat: "diner", name: "Galette de sarrasin garnie", kcal: 420, p: 22, desc: "Œuf + champignons, format crêpe salée.", ingredients: ["1 galette de sarrasin", "1 œuf", "champignons", "un peu de fromage râpé"], steps: ["Réchauffe la galette.", "Casse l'œuf au centre, ajoute champignons + fromage.", "Replie et sers."] },
  { id: "idea-soupe", cat: "diner", name: "Soupe + œufs durs", kcal: 350, p: 18, desc: "Léger, parfait après une grosse journée.", ingredients: ["gros bol de soupe de légumes maison", "2 œufs durs", "1 tranche de pain complet"], steps: ["Réchauffe la soupe.", "Sers avec œufs durs + pain."] },
  // Snack
  { id: "idea-shakefruit", cat: "snack", name: "Shake amande & fruit", kcal: 330, p: 31, desc: "Le coup de fouet protéiné.", ingredients: ["1 dose d'All-in-One ou Vegan Protein", "250 ml de lait d'amande", "1 banane ou fruits rouges"], steps: ["Mets tout au shaker ou au blender.", "Mixe/secoue."] },
  { id: "idea-skyrnoix", cat: "snack", name: "Skyr soja & noix", kcal: 230, p: 16, desc: "Crémeux + croquant.", ingredients: ["150 g de skyr/yaourt soja protéiné", "une petite poignée de noix", "un filet de miel (option)"], steps: ["Mélange.", "Ajoute les noix au moment de manger."] },
  { id: "idea-houmous", cat: "snack", name: "Houmous & crudités", kcal: 180, p: 6, desc: "À grignoter, plein de fibres.", ingredients: ["2 c. à soupe de houmous", "bâtonnets de carotte, concombre, poivron"], steps: ["Coupe les crudités.", "Trempe."] },
  { id: "idea-houmous-rouge", cat: "snack", name: "Houmous de haricots rouges maison", kcal: 250, p: 8, desc: "Ta recette (fait ~4 portions). Riche en bon gras : pour alléger, descends l'huile d'olive à 1 c. à soupe et rallonge à l'eau/aquafaba (~190 kcal/portion).", ingredients: ["300 g de haricots rouges cuits", "3 c. à soupe de tahini", "3 c. à soupe d'huile d'olive (1 suffit pour alléger)", "1/2 citron pressé", "sel, poivre"], steps: ["Mixe tout jusqu'à consistance lisse.", "Ajoute un peu d'eau ou d'aquafaba (jus de la boîte) si trop épais.", "Rectifie sel et citron. Sers avec des crudités."] },
  { id: "idea-clearbarre", cat: "snack", name: "Clear Vegan & barre", kcal: 270, p: 32, desc: "Très protéiné, faible en gras.", ingredients: ["1 dose de Clear Vegan à l'eau glacée", "1 barre gourmet vegane Bulk"], steps: ["Prépare la Clear bien froide.", "Accompagne de la barre."] },
  // — Lot 2 —
  { id: "idea-porridge", cat: "pdj", name: "Porridge protéiné chaud", kcal: 400, p: 35, desc: "Chaud et réconfortant les matins d'hiver.", ingredients: ["40 g de flocons d'avoine", "250 ml de lait d'amande", "1 dose de Vegan Protein", "1/2 banane en rondelles", "cannelle"], steps: ["Cuis flocons + lait 3-4 min en remuant.", "Hors du feu, incorpore la protéine.", "Garnis de banane et cannelle."] },
  { id: "idea-chia", cat: "pdj", name: "Chia pudding amande", kcal: 300, p: 20, desc: "Se prépare la veille, ultra rassasiant.", ingredients: ["30 g de graines de chia", "250 ml de lait d'amande", "1/2 dose de Vegan Protein", "fruits rouges"], steps: ["Mélange chia + lait + protéine.", "Repos une nuit au frigo.", "Ajoute les fruits au matin."] },
  { id: "idea-toastoeuf", cat: "pdj", name: "Toast œuf-avocat", kcal: 430, p: 20, desc: "Le brunch express, bon gras maîtrisé.", ingredients: ["2 tranches de pain complet", "1/2 avocat", "2 œufs pochés ou au plat", "citron, piment"], steps: ["Toaste le pain, écrase l'avocat dessus.", "Cuis les œufs.", "Pose-les sur le toast, citron + piment."] },
  { id: "idea-dahl", cat: "dej", name: "Dahl de lentilles corail", kcal: 520, p: 22, desc: "Épicé, réconfortant, peu de gras.", ingredients: ["80 g de lentilles corail (crues)", "150 ml de lait de coco allégé", "tomate, oignon, épices (curcuma, cumin)", "60 g de riz basmati (cru) cuit"], steps: ["Fais revenir oignon + épices.", "Ajoute lentilles, tomate, coco, mijote 15 min.", "Sers sur le riz."] },
  { id: "idea-poke", cat: "dej", name: "Poke bowl tofu", kcal: 480, p: 28, desc: "Frais, façon hawaïen.", ingredients: ["80 g de riz (cru) cuit", "120 g de tofu fumé en dés", "edamame", "concombre, carotte, oignon rouge", "sauce soja + sésame"], steps: ["Dispose le riz tiède dans un bol.", "Ajoute tofu, edamame et crudités.", "Nappe de sauce, parsème de sésame."] },
  { id: "idea-chili", cat: "dej", name: "Chili sin carne", kcal: 520, p: 32, desc: "Avec haché végétal et haricots rouges.", ingredients: ["150 g de haricots rouges", "100 g de haché végétal (Garden Gourmet)", "tomate concassée, poivron, épices chili", "60 g de riz (cru) cuit"], steps: ["Fais revenir haché + poivron.", "Ajoute tomate, haricots, épices, mijote 15 min.", "Sers avec le riz."] },
  { id: "idea-pates", cat: "diner", name: "Pâtes complètes & boulettes La Vie", kcal: 520, p: 28, desc: "Le confort food protéiné.", ingredients: ["80 g de pâtes complètes (crues)", "boulettes La Vie", "sauce tomate basilic", "parmesan végétal (option)"], steps: ["Cuis les pâtes.", "Réchauffe boulettes dans la sauce tomate.", "Mélange et sers."] },
  { id: "idea-shakshuka", cat: "diner", name: "Shakshuka", kcal: 400, p: 22, desc: "Œufs pochés dans une sauce tomate-poivron.", ingredients: ["3 œufs", "tomate concassée, poivron, oignon", "cumin, paprika", "1 tranche de pain complet"], steps: ["Mijote tomate + poivron + épices.", "Casse les œufs dedans, couvre 5-6 min.", "Sers avec le pain pour saucer."] },
  { id: "idea-tofuwok", cat: "diner", name: "Tofu teriyaki & riz sauté légumes", kcal: 480, p: 24, desc: "Vite fait au wok.", ingredients: ["150 g de tofu teriyaki La Vie", "80 g de riz (cru) cuit", "wok de légumes (poivron, brocoli, petits pois)", "sauce soja"], steps: ["Saute les légumes au wok.", "Ajoute le riz cuit et le tofu, fais sauter.", "Déglace à la sauce soja."] },
  { id: "idea-edamame", cat: "snack", name: "Edamame vapeur", kcal: 190, p: 17, desc: "Le snack le plus protéiné qui soit.", ingredients: ["150 g d'edamame (dans la cosse)", "sel, ou un peu de piment"], steps: ["Cuis 5 min à la vapeur ou à l'eau bouillante.", "Sale et déguste en pressant les cosses."] },
  { id: "idea-mugcake", cat: "snack", name: "Mug cake protéiné", kcal: 220, p: 28, desc: "Dessert chaud en 1 min au micro-ondes.", ingredients: ["1 dose de Vegan Protein (chocolat)", "1 c. à soupe de cacao", "1/2 banane écrasée", "1 blanc d'œuf", "1/2 c. à café de levure"], steps: ["Mélange tout dans un mug.", "Micro-ondes 1 min.", "Laisse tiédir 1 min avant de manger."] },
  { id: "idea-pommePB", cat: "snack", name: "Pomme & purée de cacahuète", kcal: 180, p: 4, desc: "Sucré-salé, croquant.", ingredients: ["1 pomme en quartiers", "1 c. à soupe de purée de cacahuète"], steps: ["Coupe la pomme.", "Trempe dans la purée de cacahuète."] },
];
