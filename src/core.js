...
const MEAL_IDEAS = [
  ...
  { id: "idea-pancakes", cat: "pdj", name: "Pancakes protéinés", emoji: "🥞", kcal: 400, p: 35, desc: "Sans huile, à la poêle antiadhésive.", ingredients: ["40 g de flocons mixés", "2 œufs", "1 banane écrasée", "1/2 dose de Vegan Protein", "cannelle"], steps: ["Mixe le tout en pâte.", "Cuis en petits pancakes, poêle antiadhésive sans huile.", "Garnis de fruits ou d'un filet de sirop léger."] },
  { id: "idea-tofuscramble", cat: "pdj", name: "Tofu brouillé express", emoji: "🍳", kcal: 290, p: 22, desc: "L'alternative aux œufs, goût brouillé.", ingredients: ["150 g de tofu ferme", "curcuma, paprika, sel kala namak (goût œuf)", "1 tranche de pain complet"], steps: ["Écrase le tofu à la fourchette.", "Poêle antiadhésive + épices, 5 min.", "Sers avec le pain."] },
  { id: "idea-skyrmuesli", cat: "pdj", name: "Skyr soja & muesli", emoji: "🥣", kcal: 320, p: 20, desc: "Rapide. Choisis un skyr SOJA (plus protéiné que l'amande) et un muesli sans sucre ajouté.", ingredients: ["150 g de skyr/yaourt soja protéiné", "40 g de muesli sans sucre ajouté", "fruits frais"], steps: ["Mélange skyr + muesli.", "Ajoute les fruits."] },
  // Déjeuner
  { id: "idea-buddha", cat: "dej", name: "Buddha bowl tofu", emoji: "🥗", kcal: 470, p: 32, desc: "Protéiné, frais, sec en gras.", ingredients: ["150 g de tofu fumé ou teriyaki", "80 g de quinoa (cru) cuit", "80 g d'edamame", "crudités (carotte, chou, concombre)", "sauce soja + citron + gingembre"], steps: ["Cuis le quinoa.", "Poêle le tofu.", "Assemble avec edamame et crudités, nappe de sauce."] },
  ...
  { id: "idea-wrap", cat: "dej", name: "Wrap protéiné", emoji: "🌯", kcal: 400, p: 22, desc: "À emporter, se mange à une main.", ingredients: ["1 tortilla complète", "jambon La Vie ou tofu", "crudités", "1 c. à soupe de houmous"], steps: ["Tartine le houmous.", "Garnis de protéine + crudités.", "Roule serré."] },
  { id: "idea-medbowl", cat: "dej", name: "Bowl méditerranéen", emoji: "🥙", kcal: 470, p: 26, desc: "Pois chiches + œuf, frais et complet.", ingredients: ["150 g de pois chiches", "1 œuf dur", "concombre + tomate", "60 g de boulgour (cru) cuit", "citron, herbes"], steps: ["Cuis le boulgour.", "Assemble pois chiches, œuf, légumes.", "Assaisonne citron + herbes."] },
  // Dîner
  ...
  { id: "idea-soupe", cat: "diner", name: "Soupe + œufs durs", emoji: "🍲", kcal: 350, p: 18, desc: "Léger, parfait après une grosse journée.", ingredients: ["gros bol de soupe de légumes maison", "2 œufs durs", "1 tranche de pain complet"], steps: ["Réchauffe la soupe.", "Sers avec œufs durs + pain."] },
  // Snack
  { id: "idea-shakefruit", cat: "snack", name: "Shake amande & fruit", emoji: "🥤", kcal: 330, p: 31, desc: "Le coup de fouet protéiné.", ingredients: ["1 dose d'All-in-One ou Vegan Protein", "250 ml de lait d'amande", "1 banane ou fruits rouges"], steps: ["Mets tout au shaker ou au blender.", "Mixe/secoue."] },
  { id: "idea-skyrnoix", cat: "snack", name: "Skyr soja & noix", emoji: "🥜", kcal: 230, p: 16, desc: "Crémeux + croquant.", ingredients: ["150 g de skyr/yaourt soja protéiné", "une petite poignée de noix", "un filet de miel (option)"], steps: ["Mélange.", "Ajoute les noix au moment de manger."] },
  { id: "idea-houmous", cat: "snack", name: "Houmous & crudités", emoji: "🥕", kcal: 180, p: 6, desc: "À grignoter, plein de fibres.", ingredients: ["2 c. à soupe de houmous", "bâtonnets de carotte, concombre, poivron"], steps: ["Coupe les crudités.", "Trempe."] },
  { id: "idea-houmous-rouge", cat: "snack", name: "Houmous de haricots rouges maison", emoji: "🫘", kcal: 250, p: 8, desc: "Ta recette (fait ~4 portions). Riche en bon gras : pour alléger, descends l'huile d'olive à 1 c. à soupe et rallonge à l'eau/aquafaba (~190 kcal/portion).", ingredients: ["300 g de haricots rouges cuits", "3 c. à soupe de tahini", "3 c. à soupe d'huile d'olive (1 suffit pour alléger)", "1/2 citron pressé", "sel, poivre"], steps: ["Mixe tout jusqu'à consistance lisse.", "Ajoute un peu d'eau ou d'aquafaba (jus de la boîte) si trop épais.", "Rectifie sel et citron. Sers avec des crudités."] },
  { id: "idea-clearbarre", cat: "snack", name: "Clear Vegan & barre", emoji: "🍫", kcal: 270, p: 32, desc: "Très protéiné, faible en gras.", ingredients: ["1 dose de Clear Vegan à l'eau glacée", "1 barre gourmet vegane Bulk"], steps: ["Prépare la Clear bien froide.", "Accompagne de la barre."] },
  // — Lot 2 —
  ...
  { id: "idea-chia", cat: "pdj", name: "Chia pudding amande", emoji: "🍮", kcal: 300, p: 20, desc: "Se prépare la veille, ultra rassasiant.", ingredients: ["30 g de graines de chia", "250 ml de lait d'amande", "1/2 dose de Vegan Protein", "fruits rouges"], steps: ["Mélange chia + lait + protéine.", "Repos une nuit au frigo.", "Ajoute les fruits au matin."] },
  { id: "idea-toastoeuf", cat: "pdj", name: "Toast œuf-avocat", emoji: "🥑", kcal: 430, p: 20, desc: "Le brunch express, bon gras maîtrisé.", ingredients: ["2 tranches de pain complet", "1/2 avocat", "2 œufs pochés ou au plat", "citron, piment"], steps: ["Toaste le pain, écrase l'avocat dessus.", "Cuis les œufs.", "Pose-les sur le toast, citron + piment."] },
  ...
  { id: "idea-edamame", cat: "snack", name: "Edamame vapeur", emoji: "🫛", kcal: 190, p: 17, desc: "Le snack le plus protéiné qui soit.", ingredients: ["150 g d'edamame (dans la cosse)", "sel, ou un peu de piment"], steps: ["Cuis 5 min à la vapeur ou à l'eau bouillante.", "Sale et déguste en pressant les cosses."] },
  { id: "idea-mugcake", cat: "snack", name: "Mug cake protéiné", emoji: "🧁", kcal: 220, p: 28, desc: "Dessert chaud en 1 min au micro-ondes.", ingredients: ["1 dose de Vegan Protein (chocolat)", "1 c. à soupe de cacao", "1/2 banane écrasée", "1 blanc d'œuf", "1/2 c. à café de levure"], steps: ["Mélange tout dans un mug.", "Micro-ondes 1 min.", "Laisse tiédir 1 min avant de manger."] },
  { id: "idea-pommePB", cat: "snack", name: "Pomme & purée de cacahuète", emoji: "🍎", kcal: 180, p: 4, desc: "Sucré-salé, croquant.", ingredients: ["1 pomme en quartiers", "1 c. à soupe de purée de cacahuète"], steps: ["Coupe la pomme.", "Trempe dans la purée de cacahuète."] },
  ...
  { id: "idea-hpsalad", cat: "dej", name: "Salade vegan hyper-protéinée", emoji: "🥗", kcal: 450, p: 35, desc: "Inspirée de The Conscious Plant Kitchen. Le combo edamame + pois chiches + tofu.", ingredients: ["80 g d'edamame", "100 g de pois chiches", "80 g de tofu fumé en dés", "crudités + graines de courge", "sauce tahini + citron + eau"], steps: ["Assemble edamame, pois chiches, tofu et crudités.", "Émulsionne tahini + citron + un peu d'eau.", "Nappe, parsème de graines."] },
  ...
  { id: "idea-coleslaw", cat: "snack", name: "Coleslaw au skyr", emoji: "🥗", kcal: 150, p: 8, desc: "Inspirée de Recettes de Julie. Sauce skyr soja au lieu de mayo : léger et protéiné.", ingredients: ["chou + carotte râpés", "150 g de skyr/yaourt soja", "moutarde, citron, sel", "ciboulette"], steps: ["Râpe chou et carotte.", "Mélange skyr soja + moutarde + citron.", "Lie et laisse reposer 10 min."] },
  { id: "idea-jusvert", cat: "snack", name: "Jus vert concombre-kiwi-gingembre", emoji: "🥬", kcal: 90, p: 2, desc: "Inspirée de Recettes de Julie. Rafraîchissant et peu calorique — mais c'est un jus : peu de fibres, zéro protéine. Un plaisir hydratant, pas un repas.", ingredients: ["1 concombre", "1 kiwi", "un morceau de gingembre", "citron"], steps: ["Passe le tout à l'extracteur (ou mixe puis filtre).", "Sers bien frais."] },
];
