...
export const EXERCISES = {
  ...
  // ── Poussée (haut) ──
  floor_press:    { id: "floor_press",     name: "Floor press kettlebells",       muscles: ["pectoraux", "triceps"],     pattern: "horizontal_push", legacyNames: ["Floor press kettlebells"] },
  ...
  triceps_ext_kb: { id: "triceps_ext_kb",  name: "Extension triceps kettlebell",  muscles: ["triceps"],                  pattern: "elbow_extension", legacyNames: ["Extension triceps kettlebell"] },
