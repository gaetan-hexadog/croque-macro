...
// ════════════════════════════════════════════════════════════════════════════
export const CLEAR_PROTEIN_DOSE = { kcal: 86, p: 20 }; // 1 dose officielle Bulk (Clear Whey Isolate)
...
export const CLEAR_PROTEIN_VERRE = glassOf(CLEAR_PROTEIN_DOSE); // → 34 / 8
