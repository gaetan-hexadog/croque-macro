...
export function Toast({ toast, onClose }) {
  ...
  return (
    <div className="fixed inset-x-0 z-40 flex justify-center px-4" style={{ bottom: "calc(env(safe-area-inset-bottom) + 5.5rem)" }}>
      <div className="flex items-center gap-3 rounded-full py-2.5 pl-4 pr-2" style={{ backgroundColor: C.cardSolid || C.sheet, border: `1px solid ${C.line}`, boxShadow: `0 12px 32px -12px ${C.shadow}` }}>
